...
const HeaderLeft = () => {
  return (
    <div className='md:flex-[1]'>
      <div className='min-h-screen top-0 hidden md:sticky md:flex items-center justify-center bg-indigo-600 text-white'>
        <ul className='flex flex-col gap-10'>
          {['home', 'about', 'experience', 'on campus', 'projects'].
            map((item) => (
      ...
      {/* <div className='fixed left-0 right-0 top-0 z-10 flex justify-evenly bg-indigo-600 p-5 text-white md:hidden'>
